		...
		try {
			...
			createKanban.setOnAction(new EventHandler<ActionEvent>() {
			    public void handle(ActionEvent t) {
			        ...
			        Label laneNumLbl = new Label("Number of Lanes");
			     ...
			     // First name label
			        GridPane.setHalignment(laneNumLbl, HPos.RIGHT);
			        gridpane.add(laneNumLbl, 0, 1);
			...
			editKanban.setOnAction(new EventHandler<ActionEvent>() {
			    public void handle(ActionEvent t) {
			        ...
			        Label fNameLbl = new Label("Edit Kanban Name");
			        TextField fNameFld = new TextField();
			        Label laneNumLbl = new Label("Edit Num Lanes");
			        Button deleteButton = new Button("Delete Kanban");
